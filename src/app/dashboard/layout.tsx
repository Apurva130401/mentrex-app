...
import { LayoutDashboard, CreditCard, Key, LogOut, BookOpen, ExternalLink, Menu, LifeBuoy, FileCode, Workflow, Settings, History as HistoryIcon } from "lucide-react"
        ...
        <div className="flex h-full flex-col font-sans">
            ...
            <nav className="flex-1 p-6 space-y-2">
                ...
                <div className="pt-4 mt-4 border-t border-border/40">
                    ...
                    <Link href="https://changelog.mentrex.shop" target="_blank" rel="noopener noreferrer">
                        <span className="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium text-muted-foreground transition-all duration-200 hover:bg-muted/50 hover:text-foreground group">
